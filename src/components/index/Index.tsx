    ...
    return (
        <div css={style}>
            ...
            <Faq header="Why can't I find library XYZ?">
                For now, it only shows a handful of libraries. The goal is to support all NPM
                libraries, once the site is feature complete.
            </Faq>
            <Faq header="The version number for some libraries are really old">
                ...
                version that was in the dump at the time. But that's fine, the goal is not to be up
                to date
            </Faq>
        </div>
    );
